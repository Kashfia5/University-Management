...
$sql="select * from result where course_id='{$c_id}' and faculty_id='{$user}'";
                    ...
                    <table>
                     ...
                     ?>
                        <tr>
                            ...
                            <td><input type="number" id="marks" value="<?php echo $row['marks'];?>"></td>
                            <td><a
                                    href="/University-Management/Controller/Faculty/removeMarks.php?id=<?= $row['id'];?>"><button
                                        id="remove-marks">REMOVE MARKS</button></a></td>
